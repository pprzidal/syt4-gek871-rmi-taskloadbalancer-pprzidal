...
public class LeastConnectionsLB implements Loadbalanceing, Compute {
    ...
    private Map<Compute, Integer> m = new HashMap<>();
    ...
    public <T> T executeTask(Task<T> t) throws RemoteException {
        ...
        synchronized (m) { //TODO nochmal nachdenken ob man hier locken muss
        ...
        synchronized (m) { //TODO muss ich hier locken?
            System.out.println("Now: " + compute + " has " + least + " connections");
            m.replace(compute, least + 1, least); //TODO selbes wie zeile 25
        }
        return retVal;
    }
